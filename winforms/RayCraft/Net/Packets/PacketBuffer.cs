...
namespace Craft.Net.Packets
{
    public class PacketBuffer
    {
        ...
        public void WriteByte(byte placedBlockDirection)
        {
            WriteRawByteArray(new byte[] { placedBlockDirection });
        }
        ...
        private void WriteRawByteArray(byte[] arr)
        {
